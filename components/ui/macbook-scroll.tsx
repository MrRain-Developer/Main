...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[400vh] sm:min-h-[250vh] md:min-h-[200vh] lg:min-h-[170vh] flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.35] sm:scale-75"
    >
      <motion.h2
        style={{
