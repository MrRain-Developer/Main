...
export function SignupForm() {
  ...
  return (
    <div className="w-full mx-auto rounded-none md:rounded-2xl  bg-white dark:bg-black">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-8">
          <Label htmlFor="inquiry">Any Inquiry?</Label>
          <textarea className="h-20 border-2 rounded-md" />
        </LabelInputContainer>
