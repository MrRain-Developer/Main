                    ...
                    <div className="max-w-4xl mx-auto glass p-8 rounded-lg  text-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="glass p-6 rounded-lg">
                                <h2 className="text-2xl font-semibold text-black dark:text-white mb-3 ">Our Mission</h2>
                            ...
                            <div className="glass p-6 rounded-lg">
                                <h2 className="text-2xl font-semibold text-black dark:text-white mb-3">Our Vision</h2>
                                <p className="text-black dark:text-gray-300">
